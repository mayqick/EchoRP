...
namespace Echo.Chat
{
    public class Chat : Script
    {
        ...
        {
            player.TriggerEvent("SetActiveChatMode", player.GetData<string>(EntityData.CHAT_MODE));
        }
        [RemoteEvent("ChatModeTabChanged")]
        public void OnChatModeTabChanged(Client player)
        {
            if (player.GetData<string>(EntityData.CHAT_MODE) == "Say") player.SetData(EntityData.CHAT_MODE, "Yell");
            else if (player.GetData<string>(EntityData.CHAT_MODE) == "Yell") player.SetData(EntityData.CHAT_MODE, "Whisper");
            else if (player.GetData<string>(EntityData.CHAT_MODE) == "Whisper") player.SetData(EntityData.CHAT_MODE, "Ooc");
            else if (player.GetData<string>(EntityData.CHAT_MODE) == "Ooc") player.SetData(EntityData.CHAT_MODE, "me");
            else if (player.GetData<string>(EntityData.CHAT_MODE) == "me") player.SetData(EntityData.CHAT_MODE, "do");
            else if (player.GetData<string>(EntityData.CHAT_MODE) == "do") player.SetData(EntityData.CHAT_MODE, "try");
            else if (player.GetData<string>(EntityData.CHAT_MODE) == "try") player.SetData(EntityData.CHAT_MODE, "Say");
        ...
        public void OnChatMessage(Client player, string message)
        {
            ...
            else
            {
                ...
                {
                    if (player.GetData<string>(EntityData.CHAT_MODE) == "Say") SendMessageToNearbyPlayers(player, message, Constants.MESSAGE_TALK, player.Dimension > 0 ? 7.5f : 10.0f);
                    else if (player.GetData<string>(EntityData.CHAT_MODE) == "Yell") SendMessageToNearbyPlayers(player, message, Constants.MESSAGE_YELL, 45.0f);
                    else if (player.GetData<string>(EntityData.CHAT_MODE) == "Whisper") SendMessageToNearbyPlayers(player, message, Constants.MESSAGE_WHISPER, 3.0f);
                    else if (player.GetData<string>(EntityData.CHAT_MODE) == "Ooc") SendMessageToNearbyPlayers(player, message, Constants.MESSAGE_OOC, player.Dimension > 0 ? 5.0f : 10.0f);
                    else if (player.GetData<string>(EntityData.CHAT_MODE) == "me") SendMessageToNearbyPlayers(player, message, Constants.MESSAGE_ME, player.Dimension > 0 ? 7.5f : 20.0f);
                    else if (player.GetData<string>(EntityData.CHAT_MODE) == "do") SendMessageToNearbyPlayers(player, message, Constants.MESSAGE_DO, player.Dimension > 0 ? 7.5f : 20.0f);
                    else if (player.GetData<string>(EntityData.CHAT_MODE) == "try")
                    {
