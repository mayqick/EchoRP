    ...
    class Auth : Script
    {
        ...
        public void RegisterPlayer(Client player)
        {
            ...
            NAPI.Task.Run(() =>
            {
                ...
                Database.Database.RegisterAccount(player.SocialClubName, token, player.Serial, player.Address, player.GetData<string>(EntityData.PLAYER_MAIL));
            });
        ...
        {
            AccountModel account = player.GetData<AccountModel>("accountAuthInfo");
        ...
        public void LoginToAccount(Client player, string login, string password)
        {
            NAPI.Task.Run(() =>
            {
                int attempts = player.GetData<int>("AuthCount");
