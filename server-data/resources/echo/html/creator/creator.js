var app = new Vue({
  ...
  methods: {
    ...
    updateTrueFace() {
      ...
      post('http://echo/SendCharacterSettings', JSON.stringify(data)
      );
    }
  }
})
// нам нужно регу доделать
// я делаю фронтенд потому что верстала запросил 6к рублей за это